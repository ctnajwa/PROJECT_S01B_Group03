...
$committee_query = $conn->query("
    SELECT user.user_name, committee.committee_role 
    FROM committee
...
<body>
	...
	<div class="content">
		...
		<table>
			...
			<?php if ($committee_query->num_rows > 0): ?>
				<?php while ($row = $committee_query->fetch_assoc()): ?>
					<tr>
				...
				<?php endwhile; ?>
			<?php else: ?>
				<tr><td colspan="2">No committee assigned yet.</td></tr>
			<?php endif; ?>
		</table>
